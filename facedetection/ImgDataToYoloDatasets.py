...
dataset_folder = '/home/ken/Desktop/program/yolov7/facedetection/widerface/val'
...
with open('val.txt', 'w') as train_f:
...
print(f"Generated train.txt and val.txt with {len(train_files)} train ")
